...
class Datasets():
    ...
    def calc_mean_and_std(self):
        ...
        data_sample = np.zeros((hp.preprocess_sample_size, img_size, img_size, 3))
    ...
    def get_data(self, path, pretrained, shuffle, augment):
        """ Returns an image data generator which can be iterated
        through for images and corresponding class labels.

        Arguments:
            path - Filepath of the data being imported, such as "../data/train" or "../data/test"
            pretrained - Boolean value indicating whether VGG or MobilNet preprocessing should be used.
